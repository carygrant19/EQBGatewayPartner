$(function () {
    ...
    window.Parsley.addValidator('restrictName', {
        validateString: function (value) {
            // Allows letters (including accented), spaces, dots, dashes
            const scRegex = /^[\p{L}\s.-]+$/u;
            return scRegex.test(value);
        },
        messages: {
    ...
    window.Parsley.addValidator('multiEmailValidator', {
        validateString: function (value) {
            ...
            // Split the input by semicolon and validate each email
