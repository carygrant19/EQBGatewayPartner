...
namespace Gateway.Pages.Maintenance
{
    public class CompanyModel(ICompanyService service) : PageModelExtension
    {
        ...
        //    }
        //}
        //public async Task<JsonResult> OnPostSave([FromBody] Request.Company model)
        //{
